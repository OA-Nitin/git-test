...
const STCProjectsReport = () => {
  ...
  useEffect(() => {
    document.title = "STC Projects Report - Occams Portal"; // Set title for STC Projects Report page
  ...
  const fetchProjects = async () => {
    ...
    try {
      ...
      const apiUrl = 'https://play.occamsadvisory.com/portal/wp-json/portalapi/v1/projects?product_id=937';
  ...
  const exportToPDF = () => {
    try {
      ...
      // Add title
      doc.setFontSize(16);
      doc.text('STC Projects Report', 15, 15);
  ...
  const exportToExcel = () => {
    try {
      ...
      XLSX.utils.book_append_sheet(workbook, worksheet, 'STC Projects');
              ...
              <div className="white_card_header">
                <div className="box_header m-0 new_report_header">
                  <div className="title_img">
                    ...
                    <h4 className="text-white">STC Projects Report</h4>
                  </div>
                </div>
              </div>
...
export default STCProjectsReport;