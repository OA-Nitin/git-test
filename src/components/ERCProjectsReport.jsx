...
const ERCProjectsReport = () => {
  ...
  const fetchProjects = async () => {
    ...
    try {
      ...
      const apiUrl = 'https://play.occamsadvisory.com/portal/wp-json/portalapi/v1/projects?product_id=935';
  ...
  const exportToPDF = () => {
    try {
      ...
      // Add title
      doc.setFontSize(16);
      doc.text('ERC Projects Report', 15, 15);
  ...
  const exportToExcel = () => {
    try {
      ...
      XLSX.utils.book_append_sheet(workbook, worksheet, 'ERC Projects');
