...
const AllProjectsReport = () => {
  ...
  const defaultVisibleColumns = ['projectId', 'date', 'businessName', 'productName', 'projectName', 'collaborators', 'milestone', 'stageName', 'taxNowSignupStatus'];
        ...
        <div class="card">
          <div class="card-body">
            <h5 class="card-title">
              ...
              ${project.business_legal_name || 'N/A'}
            </h5>
            <p class="card-text"><strong>Project ID:</strong> ${project.project_id || 'N/A'}</p>
            <p class="card-text"><strong>Business Phone:</strong> ${project.business_phone || 'N/A'}</p>
            <p class="card-text"><strong>Business Email:</strong> ${project.business_email || 'N/A'}</p>
            <p class="card-text"><strong>Authorized Signatory:</strong> ${project.authorized_signatory_name || 'N/A'}</p>
            <p class="card-text"><strong>Product:</strong> ${project.product_name || 'N/A'}</p>
            <p class="card-text"><strong>Project Name:</strong> ${project.project_name || 'N/A'}</p>
            <p class="card-text"><strong>Collaborators:</strong> ${project.collaborators || 'N/A'}</p>
            <p class="card-text"><strong>Milestone:</strong> ${project.milestone || 'N/A'}</p>
            <p class="card-text"><strong>Stage:</strong> ${project.stage_name || 'N/A'}</p>
            <p class="card-text"><strong>TaxNow Status:</strong> ${project.taxnow_signup_status || 'N/A'}</p>
            <p class="card-text"><strong>Created At:</strong> ${formatDate(project.created_at) || 'N/A'}</p>
          </div>
        </div>
      `,
      width: 600,
      ...
      html: `
        <div class="card">
          <div class="card-body">
            ...
            <p class="card-text"><strong>Project ID:</strong> ${project.project_id || 'N/A'}</p>
            <p class="card-text"><strong>Project Name:</strong> ${project.project_name || 'N/A'}</p>
            <p class="card-text"><strong>Project Fee:</strong> ${project.project_fee || 'N/A'}</p>
          </div>
        </div>
      `,
      width: 600,
  ...
  const handleAddNotes = (project) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        console.log('Saving notes for project:', project.project_id, 'Business:', project.business_legal_name, 'Note:', result.value);
